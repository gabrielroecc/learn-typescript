function feedback(avaliation?: number | boolean) {
  if (typeof avaliation === "number") {
    if (avaliation == 1) {
      console.log("Can we help you with something? Tell us why");
    } else if (avaliation == 2) {
      console.log(
        "You feedback was 2. You feedback was 1. Thank you for you feedback! We can help you with something?"
      );
    } else if (avaliation == 3) {
      console.log(
        "You feedback was 3.Thank you! Was a pleasure have you feedback!"
      );
